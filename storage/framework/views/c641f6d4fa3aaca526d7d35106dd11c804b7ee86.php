...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="auth-text">Вы уже есть в системе?<a href="<?php echo e(route('auth')); ?>">Авторизироваться</a></p>
    </div>
</div>
</form>
</body><?php /**PATH W:\domains\shayaxmetov-laravel\resources\views/reg.blade.php ENDPATH**/ ?>